...
/**
 * 2022/03/22
 * 처음 풀 때는 구현문제에 가까운 느낌을 받았다.
 * 나처럼 생쇼 안하고 푼 사람들 대단하다. 나는 투포인터랑 2차원 배열로 생쇼했는데 ;-;
 * 365만큼의 크기를 가진 1차원 배열로 해당 일수에 일정이 있으면 +1을 해주고 0이 있는 칸을 기준으로 직사각형 계산을 해준 풀이도 있었다. (아마도 dp풀이인가?)
 */